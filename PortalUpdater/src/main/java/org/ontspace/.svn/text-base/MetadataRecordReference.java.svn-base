 ...
 * 
 */
public interface MetadataRecordReference {

    /**
     * Provides the URI to get access to the repository
     * in which the metadata record lives.
     * @return The URI to get access to the repository
     */
    public java.net.URI getMRRAccessInterface();

    /**
     * Gets the (locally unique) metadata record identifier.
     * @return the metadata record identifier
     */
