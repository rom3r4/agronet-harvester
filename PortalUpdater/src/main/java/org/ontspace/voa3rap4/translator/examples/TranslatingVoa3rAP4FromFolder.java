 ...
 * folder
 */
public class TranslatingVoa3rAP4FromFolder {
    ...
    public static void main(String[] args) {
        ...
        Voa3rAP4QueryManagerImpl qm = null;
        ...
        try {
            ...
            qm = (Voa3rAP4QueryManagerImpl) rep.getQueryManager(qmConf.getJavaClass(),
                    qmParams);
        ...
        for (int i = 0; i < listXmlFiles.size(); i++) {
            ...
            try {
                ...
                MetadataRecordReference storeNewVoa3rap4 = qm.storeNewVoa3rAP4(vap4);
                System.out.println("LO id: " + storeNewVoa3rap4.getLocalMetadataRecordId());
            } catch (Exception ex) {
                Logger.getLogger(TranslatingVoa3rAP4FromFolder.class.getName()).log(
                        Level.SEVERE, null, ex);
            }
        }
